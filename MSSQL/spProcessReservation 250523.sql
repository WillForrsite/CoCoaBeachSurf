			...
			begin
				insert into Debug_ReservationData
				  SELECT
					...
					WITH (
					  RsrvtnID NVARCHAR(50) 'strict $.RsrvtnID',
					  RsrvtnSrc VARCHAR(16) 'strict $.RsrvtnSrc',
					  RsrvtnStatus VARCHAR(1) 'strict $.RsrvtnStatus',
					  Gst_eml NVARCHAR(100) 'strict $.Gst_eml',
					  RsrvtnDscnt DECIMAL(10, 2) 'strict $.RsrvtnDscnt',
					  RsrvtnFees DECIMAL(10, 2) 'strict $.RsrvtnFees',
					  RsrvtnTot DECIMAL(10, 2) 'strict $.RsrvtnTot'
					) AS Rsrvtndtl
					CROSS APPLY OPENJSON(Root.GstInfo)
					WITH (
					  Gst_fnme NVARCHAR(50) 'strict $.Gst_fnme',
					  Gst_lnme NVARCHAR(50) 'strict $.Gst_lnme',
					  Gst_eml NVARCHAR(100) 'strict $.Gst_eml',
					  Gst_eml2 NVARCHAR(100) 'strict $.Gst_eml2',
					  Gst_cphn1 NVARCHAR(20) 'strict $.Gst_cphn1',
					  Gst_cphn2 NVARCHAR(20) 'strict $.Gst_cphn2'
					) AS GstInfo
					CROSS APPLY OPENJSON(Root.TripDtls) 
					WITH (
					  trpRsrvtnID NVARCHAR(50) 'strict $.trpRsrvtnID',
					  trpID NVARCHAR(50) 'strict $.trpID',
					  trpStatus VARCHAR(1) 'strict $.trpStatus',
					  trpPckDate DATE 'strict $.trpPckDate',
					  trpPckTm TIME 'strict $.trpPckTm',
					  trpPssngrs NVARCHAR(50) 'strict $.trpPssngrs',
					  trpLug NVARCHAR(50) 'strict $.trpLug',
					  trpCst DECIMAL(10, 2) 'strict $.trpCst',
					  trpPckLctnTpe NVARCHAR(50) 'strict $.trpPckLctnTpe',
					  trpPckLctnUnqID NVARCHAR(50) 'strict $.trpPckLctnUnqID',
					  trpPckLctnSubUnqID NVARCHAR(50) 'strict $.trpPckLctnSubUnqID',
					  trpPckflght NVARCHAR(50) 'strict $.trpPckflght',
					  trpPckLctnTm NVARCHAR(50) 'strict $.trpPckLctnTm',
					  trpDrpLctnTpe NVARCHAR(50) 'strict $.trpDrpLctnTpe',
					  trpDrpLctnUnqID NVARCHAR(50) 'strict $.trpDrpLctnUnqID',
					  trpDrpLctnSubUnqID NVARCHAR(50) 'strict $.trpDrpLctnSubUnqID',
					  trpDrpflght NVARCHAR(50) 'strict $.trpDrpflght',
					  trpDrpLctnTm NVARCHAR(50) 'strict $.trpDrpLctnTm',
					  trpWC NVARCHAR(50) 'strict $.trpWC',
					  trpWCfld NVARCHAR(50) 'strict $.trpWCfld',
					  trpAddtnfo NVARCHAR(100) 'strict $.trpAddtnfo'
					) AS TripDtls;
			end
